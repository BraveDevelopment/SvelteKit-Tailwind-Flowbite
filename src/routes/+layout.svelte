...
<div class="dark:bg-gray-900">
	<nav
		class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-800/90 backdrop-blur fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600"
	>
		<div
...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-primary-999">
